...
export default function ForTesting() {
  ...
  return (
    <div>
      <div>
        <button className="p-4 ml-4 bg-mainBlue" onClick={createUserClient}>
          Create User Client
        </button>

        <button className="p-4 ml-4 bg-mainBlue" onClick={signInUserClient}>
          Sign In User Client
        </button>

        <button className="p-4 ml-4 bg-mainBlue" onClick={signOut}>
          Sign Out
        </button>

        <button className="p-4 ml-4 bg-mainBlue" onClick={deleteUser}>
          Delete
        </button>

        <button className="p-4 ml-4 bg-mainBlue" onClick={checkAuth}>
          Check Auth
        </button>
      </div>
      ...
      <div className={"flex flex-col"}>
        ...
        <button className={"p-4 m-4 bg-mainBlue"} onClick={createAccessory}>
          Create Accessory
        </button>

        <button className={"p-4 m-4 bg-mainBlue"} onClick={updateAccessory}>
          Update Accessory
        </button>

        <button
          className={"p-4 m-4 bg-mainBlue"}
          onClick={getAllCarAccessories}
        >
          Get All Accessories
        </button>
